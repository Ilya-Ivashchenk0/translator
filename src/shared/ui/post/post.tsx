...
export const Post: React.FC<postProps> = ({
  ...
  return (
    <article
      onClick={() => router.push(`/ru/post/${id}`)}
      className="cursor-pointer bg-secondary-bg-color rounded relative overflow-hidden flex flex-col justify-center items-center px-4 pt-4 pb-20 gap-4"
    >
